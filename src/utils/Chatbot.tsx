...
const Chatbot = () => {
  ...
  const getBotResponse = (message: string): string => {
    ...
    } else if (lowerMsg.includes('team') || lowerMsg.includes('careers') || lowerMsg.includes('leadership')) {
    ...
    } else if (lowerMsg.includes('research') || lowerMsg.includes('innovation') || lowerMsg.includes('program')) {
      return "Invent the future with us! Our Research & Innovation Program is QUANTA's engine, prototyping and validating AI systems for human and planetary needs. Focus areas include Advanced NLP, Human–AI collaboration, reliable systems, and ethics by design. Join small, elite teams for rapid iteration and visible results. Apply at research@quanta-ai.xyz.";
    } else if (lowerMsg.includes('services')) {
      return "Our services include intelligent assistants, automation tools, vision systems, and custom AI solutions. Looking to invent with us? See our Research & Innovation Program.";
    ...
    const optionGroups = [
      {
        ...
        options: [
          ...
          { icon: '🧑‍💼', label: 'Leadership Team' }, // Updated from 'Team & Careers'
      ...
      },
      {
        ...
        options: [
          ...
          { icon: '🔬', label: 'Research & Innovation' }, // Replaced 'Courses'
